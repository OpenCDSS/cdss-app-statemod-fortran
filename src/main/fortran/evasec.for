c evasec - calculates net evap to be: area (initial + final) / 2 * evap.
...
c               is not mix of percentage and 0 (proportional) data
c               provided
c                 
c
c               iout = 0 no detailed printout
c                    = n print detailed information for reservoir n
c
c               Note since daily evap data is not accommodated
...
c _________________________________________________________
c
c               Step 8; Calculate Ave Area and Net Evaporation (ac-ft)
c
