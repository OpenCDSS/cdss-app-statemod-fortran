c rtnmax - calculates maximum diversion allowable
...
c
c          Note it is used instead of rtnsec because it calculates a maximum, not actual.
c          Also it does not adjust Avail, the available water supply.
