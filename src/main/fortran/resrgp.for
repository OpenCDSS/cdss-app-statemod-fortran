c resrgp - Type 41 operating rule
c          It simulates a standard reservoir storage
c          limited to the Volume stored by one or more plans.
c          Also limits to target contents.
