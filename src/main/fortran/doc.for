...
c,
c,PsupDD(ip),   Plan,  WWSP,     datinp.f,         f8.   A diversion to both a WWSP plan $ for direct diversion
c,iwwPlan,      Plan,  WWSP,     oprinp.f,         i8,   Code if > 0 its the operating right used to indicate 
c, , , , , ,                                             a WWSP plan is simulated to allocate supplies to both a
c, , , , , ,                                             WWSP plan by Direct Diversion
c, , , , , ,
...
c, , , , , ,
c,Psto1,        Plan,  N/A,      Bomsec.f,         f8,   Plan Initial Storage
