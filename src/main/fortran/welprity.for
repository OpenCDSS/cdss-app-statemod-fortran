c welprity - Type 43 operating rule, in-priority supply for delayed
c             depletions associated with pumping. 
c             Note current time step depletions are accounted as they occur in WelRigP.
