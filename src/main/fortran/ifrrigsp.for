c ifrrigsp - Type 50 operating rule,  South Platte Compact to a Plan 
c            Similar to DirectBy but it allows the source to be an instream flow.
c            Also, the diversion occurs at the destination, not the source right location
c            (effectively reassigns the water right to the destination).
