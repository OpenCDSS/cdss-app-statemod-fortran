c reldep - A simpler approach to make a reservoir release to meet a depletion only.
c          It lets the Avail array tell us if the location and amount of return flows
