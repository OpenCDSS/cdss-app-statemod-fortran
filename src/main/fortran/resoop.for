c resoop - Type 8 operating rule, simulates an Out of Priority Bookover.
c          It is similar to rsrspu.
...
c_________________________________________________________________NoticeEnd___
      ...
      SUBROUTINE ResOOP(IW,L2,divactx,ncallx)        
c
c
...
c		iout=2 summary
      ...
      if(iout.eq.1) write(nlog,*) '  ResOop.for;'      
c
...
cr    caprem=2000000.
     ...
     1    curown(irow),SeniorA, ritrem(nrwr), RitPaper(nrwr),
...
cr    tranlim=amin1(curown(irow)-RitPaper(nrwr), tranlim)
...
cr      write(nlog,*) '  Resoop; idow, curown(idow)', idow,curown(idow)
        iwhy=6
...
cr        write(nlog,*) ' Resoop; irow, curown(irow)',irow, curown(irow)
...
C
c     IF(DIVACT.LE.0.00001) Goto 100
...
c
  270 format(/, 72('_'),/
     1 '  ResOop; Out-of-Priority Storage (Type 8)',/
