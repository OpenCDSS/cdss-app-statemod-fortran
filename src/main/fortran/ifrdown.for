c ifrdown - Type 23 operating rule
c           It calculates instream flow for a downstream call.
c           Note same as ifrrig2.for except it is called for a variable admin date.
