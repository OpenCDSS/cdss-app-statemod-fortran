c closs - calculates a diversion loss percent (pctlos())
c         when the product of (return table sum) * (percent on the river) < 100%.
...
c
c       Closs; it calculates a diversion loss percent (pctlos())
