c count - counts the number of entries in a time series
...
c
c
c     Counts the number of entries in a time series and then
c     rewinds the file and skips period of record (POR) record.
c      
c _________________________________________________________
c     Update History
c       NA
...
c _________________________________________________________
c
c     Parse through data to get time of interest.
