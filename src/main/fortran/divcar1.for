c divcar1 - Type 14 operating rule, which is similar to a standard carrier (type 11) but  
c           it recognizes an annual limit to a diversion when iopsou(4,l2) is .gt. 1.
...
c
c rrb 2021/05/02; Compiler Error Checking
