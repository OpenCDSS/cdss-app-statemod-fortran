c rtnxcu - calculates return flows for water lost during conveyance (RetTot).
c          Same as rtnsec but it does not call return that calculates CU, return flows, etc.
